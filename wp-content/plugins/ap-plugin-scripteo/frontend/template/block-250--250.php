...
// -- START -- TEMPLATE HTML
	echo '<div id="bsa-'.$template_name.'" data-is-admin="'.(bsa_role() == 'admin' ? 'yes' : 'no' ).'" class="apPluginContainer '.((isset($sid)) ? "bsaProContainer-".$sid." " : "").((!isset($sid)) ? "bsaProContainerExample " : "").'bsa-'.$template_name.' bsa-pro-col-'.$col_per_row.'">'; // -- START -- CONTAINER
