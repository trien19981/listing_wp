...
<h2 class="nav-tab-white nav-tab-wrapper">
	<a href="#bsaTabOrderForm" class="nav-tab nav-tab-active" data-group="bsaTabOrderForm">Order Form</a>
...
<form action="" method="post">
	...
	<table class="bsaAdminTable bsaMarTopNull form-table">
		...
		<tr class="bsaBottomLine">
			<th scope="row"><label for="bsa_pro_trans_edit_left_header">Header (while editing)</label></th>
			<td><input id="bsa_pro_trans_edit_left_header" name="edit_left_header" value="<?php validValue('edit_left_header'); ?>" type="text" class="regular-text"></td>
		</tr>
		<tr>
		...
		<tr>
			<th scope="row"><label for="bsa_pro_trans_form_right_button_pay">Payment Button</label></th>
			<td><input id="bsa_pro_trans_form_right_button_pay" name="form_right_button_pay" value="<?php validValue('form_right_button_pay'); ?>" type="text" class="regular-text"></td>
		</tr>
		<tr>
			<th class="bsaLast" scope="row"><label for="bsa_pro_trans_edit_right_button_pay">Save Button (while editing)</label></th>
			<td class="bsaLast"><input id="bsa_pro_trans_edit_right_button_pay" name="edit_right_button_pay" value="<?php validValue('edit_right_button_pay'); ?>" type="text" class="regular-text"></td>
		</tr>
		</tbody>
		...
		<tbody id="bsaTabAlerts" class="bsaTabAlerts bsaTbody" style="display:none">
			...
			<tr>
				<th scope="row"><label for="bsa_pro_trans_form_notice">Message if "All Ad Spaces are full."</label></th>
				<td><input id="bsa_pro_trans_form_notice" name="form_notice" value="<?php validNewValue('_trans_order_form', 'form_notice'); ?>" type="text" class="regular-text"></td>
			</tr>
			<tr>
				<th scope="row"><label for="bsa_pro_trans_login_notice">"Log in to see the order form."</label></th>
				<td><input id="bsa_pro_trans_login_notice" name="login_notice" value="<?php validNewValue('_trans_order_form', 'login_notice'); ?>" type="text" class="regular-text"></td>
			</tr>
			<tr>
		...
		<tbody id="bsaTabStats" class="bsaTabStats bsaTbody" style="display:none">
			...
			<tr>
				<th scope="row"><label for="bsa_pro_trans_stats_viewable">"Viewable by"</label></th>
				<td><input id="bsa_pro_trans_stats_viewable" name="viewable" value="<?php validNewValue('_trans_statistics', 'viewable'); ?>" type="text" class="regular-text"></td>
			</tr>
			<tr>
				<th scope="row"><label for="bsa_pro_trans_stats_view_sec">"seconds"</label></th>
				<td><input id="bsa_pro_trans_stats_view_sec" name="view_sec" value="<?php validNewValue('_trans_statistics', 'view_sec'); ?>" type="text" class="regular-text"></td>
			</tr>
			<tr>
				<th scope="row"><label for="bsa_pro_trans_stats_view_min">"minutes"</label></th>
				<td><input id="bsa_pro_trans_stats_view_min" name="view_min" value="<?php validNewValue('_trans_statistics', 'view_min'); ?>" type="text" class="regular-text"></td>
			</tr>
			<tr>
				<th scope="row"><label for="bsa_pro_trans_stats_total">"Total"</label></th>
				<td><input id="bsa_pro_trans_stats_total" name="total" value="<?php validNewValue('_trans_statistics', 'total'); ?>" type="text" class="regular-text"></td>
			</tr>
			<tr>
		...
		<tbody id="bsaTabEmails" class="bsaTabEmails bsaTbody" style="display:none">
			...
			<tr>
				<th class="bsaLast" scope="row"><label for="bsa_pro_trans_expired_message">Message</label></th>
				<td class="bsaLast">
					<p class="description">Use the message variable <strong>[AD_ID]</strong> and <strong>[STATS_URL]</strong> to display Ad ID.</p>
		...
		<tr>
			<th class="bsaLast" scope="row"><label for="bsa_pro_trans_powered">"Powered by"</label></th>
			<td class="bsaLast"><input id="bsa_pro_trans_powered" name="powered" value="<?php validValue('powered'); ?>" type="text" class="regular-text"></td>
		</tr>
		</tbody>
		...
		<tr>
			<th scope="row"><label for="up_assigned_to">"assigned to (site)"</label></th>
			<td><input id="up_assigned_to" name="up_assigned_to" value="<?php echo bsa_get_trans('user_panel', 'assigned_to'); ?>" type="text" class="regular-text"></td>
		</tr>
		<tr>
		...
		<tr>
			<th scope="row"><label for="up_display_limit">"Display Limit"</label></th>
		...
		<tr>
			<th scope="row"><label for="up_viewable">"Viewable by"</label></th>
			<td><input id="up_viewable" name="up_viewable" value="<?php echo bsa_get_trans('user_panel', 'viewable'); ?>" type="text" class="regular-text"></td>
		</tr>
		<tr>
			<th scope="row"><label for="up_view_sec">"seconds"</label></th>
			<td><input id="up_view_sec" name="up_view_sec" value="<?php echo bsa_get_trans('user_panel', 'view_sec'); ?>" type="text" class="regular-text"></td>
		</tr>
		<tr>
			<th scope="row"><label for="up_view_min">"minutes"</label></th>
			<td><input id="up_view_min" name="up_view_min" value="<?php echo bsa_get_trans('user_panel', 'view_min'); ?>" type="text" class="regular-text"></td>
		</tr>
		<tr>
		...
		<tr>
			<th class="bsaLast" scope="row"><label for="up_login_here">"Please log in here >"</label></th>
			<td class="bsaLast"><input id="up_login_here" name="up_login_here" value="<?php echo bsa_get_trans('user_panel', 'login_here'); ?>" type="text" class="regular-text"></td>
		</tr>
		</tbody>
		<tbody id="bsaTabAffiliate" class="bsaTabAffiliateProgram bsaTbody" style="display:none">
		<tr>
			<th colspan="2">
				<h3><span class="dashicons dashicons-editor-spellcheck"></span> Affiliate Program (<a href="https://1.envato.market/M6K6K" target="_blank">Affiliate Program Add-on</a>)</h3>
			</th>
		</tr>
		<tr>
		...
		<tr>
			<th scope="row"><label for="ap_ref_notice">"Please log in to see your referral link."</label></th>
		...
		<tr>
			<th colspan="2">
				<h3><span class="dashicons dashicons-editor-spellcheck"></span> Marketing Agency (<a href="https://1.envato.market/M6K6K" target="_blank">Marketing Agency Add-on</a>)</h3>
			</th>
		</tr>
		<tr>
