...
<table class="event-import-table">
	...
	<tbody>
		...
		foreach ($field_value as $key => $subArray) {
			if (is_array($subArray) && count(array_filter($subArray)) === 0) {
...
<div class="import-method method-serialized mt15">
	<p class="mt5 mb5">
		Enter recurring dates as serialized arrays. e.g. "a:1:{i:0;a:5:{s:5:"start";s:19:"2024-01-10 00:00:00";s:3:"end";s:19:"2024-01-12 00:00:00";s:6:"repeat";b:1;s:9:"frequency";s:7:"2 weeks";s:5:"until";s:10:"2024-02-29";}}"
	</p>
