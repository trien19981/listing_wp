...
<div class="wrap">
	<form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ) ?>" method="POST">
		...
		<div class="form-group mb30 dibvt" style="margin-right:40px;">
			<h4 class="m-heading mb10">Enable views</h4>
			<label class="form-switch">
				<input type="checkbox" name="enable_chart_views" value="1" <?php checked( true, (bool) $config['enable_chart_views'] ) ?>>
				<span class="switch-slider"></span>
			</label>
		</div>

		<div class="form-group mb30 dibvt" style="margin-right:40px;">
			<h4 class="m-heading mb10">Enable unique views</h4>
			<label class="form-switch">
				<input type="checkbox" name="enable_chart_unique_views" value="1" <?php checked( true, (bool) $config['enable_chart_unique_views'] ) ?>>
				<span class="switch-slider"></span>
			</label>
		</div>
