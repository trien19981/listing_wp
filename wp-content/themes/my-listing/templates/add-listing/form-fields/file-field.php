...
<div class="file-upload-field <?php echo $is_multiple ? 'multiple-uploads' : 'single-upload' ?> form-group-review-gallery ajax-upload">
		...
		<div class="upload-file review-gallery-add">
			...
			<div class="content">
				<input
					...
					data-file_size="<?php echo ! empty( $field['file_size_limit'] ) ? absint( $field['file_size_limit'] ) : '' ?>"
	...
	<small class="description">
		<?php printf( _x( 'Maximum file size: %s.', 'Add listing form', 'my-listing' ), ! empty( $field['file_size_limit'] ) ? absint( $field['file_size_limit'] ) . 'KB' : size_format( wp_max_upload_size() ) ); ?>
