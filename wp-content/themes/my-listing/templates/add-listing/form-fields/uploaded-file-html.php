	...
	<span class="uploaded-file-preview">
		<?php if ( $is_image ): ?>
			<span class="job-manager-uploaded-file-preview">
				<img alt="<?php echo esc_attr( _ex( 'Uploaded file', 'Uploaded file alt text', 'my-listing' ) ) ?>" src="<?php echo esc_url( $value ? c27()->get_resized_image( $value, 'medium' ) : '' ) ?>">
			</span>
		<?php else: ?>
		...
		<a href="#" class="remove-uploaded-file review-gallery-image-remove job-manager-remove-uploaded-file"><i class="mi delete"></i></a>
	</span>
