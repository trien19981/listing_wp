...
wp_enqueue_script( 'mylisting-my-listings' );
				...
				<tr class="listing-cell item-id-<?php echo $listing->get_id() ?> item-product-<?php echo $listing->get_product_id()?:'na' ?> item-type-<?php echo $listing->type?$listing->type->get_slug():'na' ?>">
					<td class="l-type">
						<div class="info listing-type">
							<a href="<?php echo esc_url( $listing->type ? add_query_arg( 'filter_by_type', $listing->type->get_slug(), $endpoint ) : '' ) ?>">
								<div class="value">
					...
					<td class="c27_listing_logo">
						...
						<?php endif ?>
						<img src="<?php echo $listing->get_logo('thumbnail') ?: ($listing->type && ( $default_marker = $listing->type->get_default_marker( 'thumbnail' ) ) ? $default_marker : c27()->image( 'marker.jpg' )) ?>">
						<?php if ( $listing->get_data('post_status') === 'publish' ) : ?>
							</a>
						<?php endif ?>
					</td>
					...
					<td class="listing-actions">
						<ul class="job-dashboard-actions no-list-style">
