...
wp_enqueue_script( 'mylisting-visits-chart' );
...
<div class="element">
	...
	<div class="pf-body">
		<div id="visits-chart-wrapper">
			<div id="cts-visits-chart" 
			data-stats="<?php echo c27()->encode_attr( $charts ) ?>"
			data-chart-types="<?php 
			echo esc_attr( wp_json_encode( [
				'views' => mylisting()->get( 'stats.enable_chart_views' ),
				'uniqueviews' => mylisting()->get( 'stats.enable_chart_unique_views' ),
			] ) );
		?>"
		></div>
		</div>
		<div class="chart-legend">
			<ul class="no-list-style">
				<?php if ( mylisting()->get( 'stats.enable_chart_views' ) ): ?>
				<li>
					<span class="lg-blue"></span>
					<?php _ex( 'Views', 'User Dashboard', 'my-listing' ) ?>
				</li>
				<?php endif ?>
				<?php if ( mylisting()->get( 'stats.enable_chart_unique_views' ) ): ?>
				<li>
