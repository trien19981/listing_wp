...
### Is it possible to link listings with WP posts?
Yes that's also available. In the `Related Listing` field select `WP Posts` and `Relation Type` to one of `Has One\ Has many`
