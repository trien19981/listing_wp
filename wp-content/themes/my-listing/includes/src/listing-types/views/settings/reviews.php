<reviews inline-template v-if="currentSubTab === 'reviews'">
	<div class="tab-content full-width">
		...
		<div class="editor-column col-1-2 rows row-padding">
			...
			<div class="form-section mb40" :class="!$root.settings.reviews.ratings.enabled ? 'ml-overlay-disabled' : ''">
			...
			<div class="form-section">
				<h4 class="mb10">Allow author reviews</h4>
				<p>Allow author of current listing to comment/review</p>
				<label class="form-switch">
					<input type="checkbox" v-model="$root.settings.reviews.author.enabled">
					<span class="switch-slider"></span>
				</label>
			</div>
		</div><!--
