...
$claim_fields = [];
if ( \MyListing\get_claim_enabled() ) {
	$claim_fields = \MyListing\Src\Claims\get_field_types();
}
...
$type_editor_data = apply_filters( 'mylisting/type-editor:config', [
	...
	'taxonomies_27' => $designer->get_custom_tax_list(),
	'listing_types_27' => $designer->get_listing_types(),
] );
?>
...
<script type="text/javascript">
	var CASE27_TypeDesigner = {
		...
		claim_fields: <?php echo json_encode( $claim_fields ) ?>,
	...
	<div class="tabs-content">
		<section v-if="currentTab === 'settings'" class="section">
			<div class="sub-tabs">
				...
				<?php if ( \MyListing\get_claim_enabled() ) : ?>
					<nav-sub-item tab="settings" subtab="claim-form" label="Claim Form"></nav-sub-item>
				<?php endif; ?>
			...
			<?php if ( \MyListing\get_claim_enabled() ) : ?>
				<?php require locate_template( 'includes/src/listing-types/views/settings/claim-form.php' ) ?>
			<?php endif; ?>
