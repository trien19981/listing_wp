...
class File_Field extends Base_Claim_Field {
	...
	public function update() {
		...
		$value = $this->get_posted_value();
		$old_value = get_post_meta( $this->claim_id, '_'.$this->key, true );
		$attachment_ids = [];
		$attachment_urls = [];
		...
		update_post_meta( $this->claim_id, '_'.$this->key, $attachment_urls );
	}
	...
	public function get_editor_options() {
		...
		$this->get_file_field_settings();
		$this->get_required_option();
	}

	protected function get_file_field_settings() { ?>
