...
class Package {
	...
	public static function create( $args = [] ) {
		...
		$package_id = wp_insert_post( [
			...
			'meta_input'  => [
				...
				'_is_claimable' => $args['is_claimable'] ? 1 : '',
				'_hide_in_add_listing' => $args['hide_in_add_listing'] ? 1 : '',
	...
	/**
	 * Is package used in add listing process
	 *
	 * @since 2.10.5
	 */
	public function hide_in_add_listing() {
		return $this->package->_hide_in_add_listing ? true : false;
	}
