...
class Listing {
	...
	public function get_social_networks() {
		...
		$networks = [];
		$selectedNetwors = $this->get_field_object( 'links' )->get_prop('selected_networks');
		$allowed_networks = \MyListing\Src\Forms\Fields\Links_Field::allowed_networks($selectedNetwors);
