...
class Listing_Stats {
	...
	private $settings = [
		...
		// visits chart
		'enable_chart' => true,
		'enable_chart_views' => true,
		'enable_chart_unique_views' => true,
	...
	public function save_settings() {
    	...
    	$config['enable_chart_views'] = ! empty( $_POST['enable_chart_views'] ) ? true : false;
    	$config['enable_chart_unique_views'] = ! empty( $_POST['enable_chart_unique_views'] ) ? true : false;
    ...
    public function maybe_migrate_options() {
    	...
    	$config['enable_chart_views'] = get_option( 'options_stats_visits_chart_views_enabled' ) === '0' ? false : true;
    	$config['enable_chart_unique_views'] = get_option( 'options_stats_visits_chart_unique_views_enabled' ) === '0' ? false : true;
    	...
    	$cleanup = [
    		...
    		'stats_visits_chart_views_enabled',
    		'stats_visits_chart_unique_views_enabled',
